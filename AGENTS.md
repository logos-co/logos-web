...
| `apps/logos-demos` | Browser-native demos of the Logos stack (Next.js 16, static, no backend). Port `3005`. See [`apps/logos-demos/AGENTS.md`](apps/logos-demos/AGENTS.md). |
