import { pageCopySchema, type PageCopy } from '@repo/content/schemas'
import { routeToPageSlug } from '@repo/content/loaders'
...
const targetPath = (slug: string): string => `content/pages/en/${slug}.json`
