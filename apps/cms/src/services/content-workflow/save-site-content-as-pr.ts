...
const SITE_SETTINGS_PATH = 'content/site/en/settings.json'
const SITE_NAVIGATION_PATH = 'content/site/en/navigation.json'
const SITE_FOOTER_PATH = 'content/site/en/footer.json'
