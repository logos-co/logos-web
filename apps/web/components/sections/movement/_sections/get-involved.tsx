  ...
  return (
    <section className="bg-brand-off-white py-10 text-brand-dark-green">
      <ContentWidth className="grid gap-3 md:grid-cols-2">
        ...
        <div
          id="join-the-coalition"
          className="relative flex h-[270px] items-center justify-center overflow-hidden rounded-[160px] text-center text-brand-off-white md:h-[500px] md:rounded-[200px]"
        >
          <Image
