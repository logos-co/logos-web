      ...
      <div className="group transition-colors hover:bg-brand-dark-green/10">
        ...
        <div className="grid min-h-[116px] grid-cols-[1fr_auto] items-start gap-x-3 gap-y-3 p-3 lg:hidden">
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="ml-1 font-mono text-[12px] leading-none"
            >
              →
            </span>
          </Link>
          <p className="min-w-0 font-mono text-[12px] leading-[1.3] text-brand-dark-green">
            {mobileDescription}
          </p>
        ...
        <div className="hidden h-[50px] items-start gap-3 px-3 pt-3 lg:flex">
          ...
          <p className="min-w-0 flex-1 font-mono text-[12px] leading-[1.3] text-brand-dark-green">
