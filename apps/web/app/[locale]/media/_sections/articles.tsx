    ...
    <section className="relative h-[473px] bg-accent-tan pt-10 md:h-[359px] md:pt-2.5">
      ...
      >
        {[
          ...
          const className =
            'inline-flex cursor-pointer items-center gap-1 font-mono text-[12px] font-semibold uppercase leading-[1.35] transition-opacity hover:opacity-70'
        ...
        <a
          ...
          className="inline-flex cursor-pointer items-center gap-1 font-mono text-[12px] font-semibold uppercase leading-[1.35] transition-opacity hover:opacity-70"
        >
          <ArrowIcon direction="down" />
          {copy.navBroadcast}
        </a>
        ...
        >
          ...
          <div className="absolute left-3 top-3 flex w-[calc(100%-24px)] flex-col gap-6 desktop:h-[380px] desktop:w-[453px] desktop:justify-between desktop:gap-0">
            <div className="flex items-center gap-25.5">
              ...
              <p className="font-mono text-[12px] font-medium uppercase leading-[1.3] text-brand-off-white">
                {copy.media}
              </p>
            </div>
            ...
            <div className="flex w-full flex-col gap-3">
              ...
              <p className="font-mono text-[12px] leading-[1.3] text-brand-off-white desktop:w-full">
          ...
          <div className="absolute left-3 right-3 bottom-3 top-[292px] overflow-hidden rounded-[100px] bg-accent-tan text-brand-dark-green transition-colors group-hover:bg-brand-yellow desktop:left-auto desktop:right-3 desktop:bottom-auto desktop:top-3 desktop:h-[382px] desktop:w-[702px]">
            <span className="absolute left-1/2 top-1/2 inline-flex -translate-x-1/2 -translate-y-1/2 items-center gap-1 font-mono text-[12px] font-semibold uppercase leading-[1.35]">
              {copy.broadcastCta}
              <ArrowIcon />
            </span>
          </div>
