...
function EventPill({
  ...
  const baseClassName =
    'block rounded-lg border border-brand-dark-green/50 p-2 font-mono text-[12px] font-medium uppercase leading-[1.3]'
  ...
  return (
    <label className={cn('relative block h-[31px] w-[141px]', className)}>
      <select
        ...
        className="h-full w-full cursor-pointer appearance-none rounded-full border border-transparent bg-brand-off-white py-0 pl-6 pr-10 font-mono text-[12px] font-semibold uppercase leading-[1.35] text-brand-dark-green"
      >
  ...
  return (
    <div className={cn('flex h-[31px] items-center gap-1', className)}>
      ...
      <button
        type="button"
        onClick={onToday}
        className="flex h-[31px] w-[54px] cursor-pointer items-center justify-center rounded-full border border-brand-dark-green/30 bg-brand-off-white font-mono text-[12px] font-semibold uppercase leading-[1.35]"
      >
        {todayLabel}
      </button>
      <button
            ...
            <div className="w-[1416px]">
              <div className="grid h-[29px] grid-cols-[repeat(7,192px)] gap-3">
                {WEEKDAYS.map((day) => (
                  <span
                    key={day}
                    className="flex items-center justify-center font-mono text-[12px] font-semibold uppercase leading-[1.35]"
                  >
                    {day}
                  </span>
                ))}
