...
export function LogosStack() {
  return (
    <section className="relative -mt-px flex flex-col gap-10 border-t border-black/25 bg-brand-off-white bg-clip-padding px-3 py-16 text-brand-dark-green lg:min-h-[673px] lg:gap-[60px] lg:pt-[120px] lg:pb-[60px]">
