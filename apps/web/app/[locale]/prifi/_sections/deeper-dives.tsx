...
export function DeeperDives() {
  return (
    <section className="flex flex-col gap-10 border-t border-brand-dark-green/10 bg-gray-01 px-3 py-16 text-brand-dark-green lg:min-h-[596px] lg:justify-center lg:pt-6 lg:pb-[100px]">
