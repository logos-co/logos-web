/**
 * Activist Builder Afform definition.
 * Generated by scripts/fetch-afform-contact-form.mjs — do not edit by hand.
 * Regenerate: node scripts/fetch-afform-contact-form.mjs --form afformActivistBuilder
 */

export const AFFORM = {
  "formName": "afformActivistBuilder",
  "title": "Activist Builder",
  "serverRoute": "civicrm/Activist_Builder",
  ...
  "fields": [
    ...
    },
    {
      "entity": "Individual1",
      "join": null,
      "fieldName": "Skills_Socials.Tell_us_a_bit_about_your_background_the_kinds_of_things_you_like",
      "label": "Tell us a bit about your background, the kinds of things you like building, any projects or communities you've contributed to before, and what types of problems or infrastructure you'd be most excited to work on.",
      "required": true,
      "options": null,
      "inputAttrs": [],
    ...
    },
    {
      "entity": "Individual1",
      "join": null,
      "fieldName": "Skills_Socials.What_types_of_technologies_do_you_envision_can_help_your_local_c",
      "label": "What types of technologies do you envision can help your local community?",
      "required": true,
      "options": null,
      "inputAttrs": [],
      "formKey": "techVision",
