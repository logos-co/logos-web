...
export const AFFORM = {
  ...
  "fields": [
    ...
    },
    {
      "entity": "Individual1",
      "join": null,
      "fieldName": "Skills_Socials.Tell_us_about_your_organization_community_or_project_what_proble",
      "label": "Tell us about your organisation, community, or project, what problem you're trying to solve, what you've already built or run, and where you think collaboration with the wider network could be valuable.",
      "required": true,
      "options": null,
      "inputAttrs": [],
...
export const AFFORM_PAGE_PRIVACY = "If you're already building something in your community, ecosystem, or area of focus, we'd love to hear from you. We're looking for aligned organisations, networks, and projects creating practical alternatives around civic life, education, governance, local resilience, technology, media, mutual aid, or community infrastructure. Let us know how we can reach you, what you're building, and where you see potential to collaborate. Not every field is required, but more context helps us understand the fit. We'll review your submission and be in touch.";
