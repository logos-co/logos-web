/**
 * Contact Form Afform definition.
 * Generated by scripts/fetch-afform-contact-form.mjs — do not edit by hand.
 * Regenerate: node scripts/fetch-afform-contact-form.mjs --form afformCircleContactForm
 */

export const AFFORM = {
  "formName": "afformCircleContactForm",
  "title": "Contact Form",
  "serverRoute": "civicrm/contact",
  "confirmationMessage": "Thank you for registering, we'll be in touch soon.",
  "submitEnabled": true,
  "createSubmission": true,
  "pageHeading": "Let's Connect.",
  "pageIntro": "Be part of what’s unfolding. Receive updates on progress, gatherings and opportunities to contribute.",
  ...
  "fields": [
    {
      "entity": "Individual1",
      "join": null,
      "fieldName": "Contacts_Custom_Fields.Role",
      "label": "I'm a...",
      "required": false,
      "options": null,
      "inputAttrs": [],
    ...
    },
    {
      ...
      "label": "Skills_Socials.What_else_would_you_like_us_to_know_What_questions_do_you_have_f",
      "required": false,
      "options": null,
      "inputAttrs": [],
      "formKey": "questions",
...
export const AFFORM_NAME = "afformCircleContactForm";
