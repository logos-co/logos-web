...
const collectExpectedRoutes = async (): Promise<string[]> => {
  // RFP detail pages are generated by the route's generateStaticParams from the
  // live GitHub listing (lib/rfps-github), so derive expectations from the same
  // source rather than the content package to avoid a sourcing mismatch.
