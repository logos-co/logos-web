---
title: 'Logos Operators Dashboard Website Terms of Use | Logos'
description: 'Terms of use for the Logos Operators Dashboard website.'
heading: 'Logos Operators Dashboard - Website Terms of Use'
---
...
## 2. The Logos Operator Dashboard

The Website provides an opportunity for users of the Website to view digital tokens they hold and achieve certain reputation points for engaging in various activities or challenges described in the Website or set by Logos.

You shall only use the Website for lawful purposes, in compliance with applicable legal frameworks and in accordance with these Terms of Use. In particular, you agree not to, whether in relation to the Website or any activities you engage in or through the Website:

1. engage in, promote, or contribute to any activities in violation of applicable law or violation of legal rights of any other individual or third party, including the rights of Logos and its affiliates;
2. copy, distribute, sell, licence, create derivative works from, or in any other way exploit copyrighted material, trademarks, or any intellectual property rights of others;
3. interfere with or disrupt the integrity, safety, security, availability or performance of the Website;
4. reverse engineer, decompile, or disassemble any software used, or introduce any harmful code (e.g., viruses, worms, or spyware) intended to infiltrate or damage the Website or any connected systems;
5. interfere, disrupt, negatively affect, or inhibit other users from their use of the Website;
6. use a wallet other than your own without permission; or
7. misrepresent your relationship with Logos or its affiliates;
...
From time to time, users of the Website may achieve certain reputation points (“**XP**”) for engaging in various activities or challenges described in the Website or set by Logos. Such points do not constitute guarantees, or promises and do not represent any claims. Logos reserves the right to, at its sole discretion, at any time, with or without notice, modify or cancel the XP you have accrued or might accrue and the manner and criteria in which you might receive XP.

## 5. Disclaimers

The Website is provided by us on an ‘as is’ basis and your use of the Website is at your own sole discretion and risk.
