/**
 * CORS for the one public surface this app exposes: funnel intake. Mirrors the
 * policy `apps/civi-crm` uses today so the cutover does not change which
 * origins the website can post from.
 */
