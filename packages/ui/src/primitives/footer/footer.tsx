 ...
 * below 1025px) compacts those offsets to ~560px so the whole footer — newsletter
...
export function Footer({
  ...
  return (
    <footer
      className={`relative h-[560px] overflow-hidden bg-brand-dark-green text-brand-off-white lg:h-[688px] ${className ?? ''}`}
    >
      ...
      <div className="absolute top-[180px] left-3 h-[47px] w-[83px] overflow-hidden lg:top-[549px] lg:h-[127px] lg:w-[226px] *:size-full *:object-cover">
        {image}
      </div>

      <div className="absolute top-[180px] left-[calc(50%+6px)] lg:top-6">
        {logo}
      </div>

      {tagline && (
        <p className="text-body-serif absolute top-[231px] left-[calc(50%+6px)] w-[175px] text-brand-off-white lg:top-[22px] lg:left-[calc(83.33%+2px)] lg:w-[226px]">
          {tagline}
        </p>
      )}

      <div className="absolute top-[300px] left-3 lg:top-[133px] lg:left-[calc(50%+6px)]">
        <LinkList links={mainLinks} />
      </div>

      <div className="absolute top-[300px] left-[calc(50%+6px)] lg:top-[133px] lg:left-[calc(83.33%+3px)]">
        <LinkList links={socialLinks} />
      </div>

      <div className="absolute top-[420px] left-3 lg:top-[322px] lg:left-[calc(50%+8px)]">
        <LinkList label="Research" links={researchLinks} />
      </div>

      <div className="absolute top-[420px] left-[calc(50%+6px)] lg:top-[322px] lg:left-[calc(83.33%+3px)]">
        <LinkList label="Infrastructure" links={infrastructureLinks} />
      </div>

      <div className="absolute top-[484px] left-3 lg:top-[617px] lg:left-[calc(50%+6px)]">
